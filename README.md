...
git clone https://github.com/redbco/mesh-core.git
cd mesh-core
...
The project includes a test script for starting multiple nodes. Use `start_test_node.sh` to start nodes. The script uses TLS connections and requires build with TLS support.

```bash
# Generate TLS certificates for nodes
./generate_test_certs.sh

# Start node 1001
./start_test_node.sh 1001

# Start node 2002
./start_test_node.sh 2002
